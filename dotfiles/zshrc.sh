...
plugins=(aws battery common-aliases docker encode64 extract gem git github history history-substring-search jira lol mercurial node npm nyan python rbenv redis-cli rsync ruby screen sudo svn urltools virtualenv virtualenvwrapper)
